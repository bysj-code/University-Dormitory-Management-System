			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="状态" prop="state">
					<el-select v-model="form.state" placeholder="请选择">
						...
						<el-col v-if="user_group === '管理员' || $check_field('get','trainee_no') || $check_field('add','trainee_no') || $check_field('set','trainee_no')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="辅导员工号" prop="trainee_no">
												<el-input id="trainee_no" v-model="form_sub['trainee_no']" placeholder="请输入辅导员工号"
							  v-if="user_group === '管理员' || (form_sub['instructor_id'] && $check_field('set','trainee_no')) || (!form_sub['instructor_id'] && $check_field('add','trainee_no'))"></el-input>
					<div v-else-if="$check_field('get','trainee_no')">{{form_sub['trainee_no']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','name_of_instructor') || $check_field('add','name_of_instructor') || $check_field('set','name_of_instructor')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="辅导员姓名" prop="name_of_instructor">
												<el-input id="name_of_instructor" v-model="form_sub['name_of_instructor']" placeholder="请输入辅导员姓名"
							  v-if="user_group === '管理员' || (form_sub['instructor_id'] && $check_field('set','name_of_instructor')) || (!form_sub['instructor_id'] && $check_field('add','name_of_instructor'))"></el-input>
					<div v-else-if="$check_field('get','name_of_instructor')">{{form_sub['name_of_instructor']}}</div>
											</el-form-item>
			</el-col>
