			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="状态" prop="state">
					<el-select v-model="form.state" placeholder="请选择">
						...
						<el-col v-if="user_group === '管理员' || $check_field('get','hanguan_job_number') || $check_field('add','hanguan_job_number') || $check_field('set','hanguan_job_number')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="宿管工号" prop="hanguan_job_number">
												<el-input id="hanguan_job_number" v-model="form_sub['hanguan_job_number']" placeholder="请输入宿管工号"
							  v-if="user_group === '管理员' || (form_sub['housing_management_users_id'] && $check_field('set','hanguan_job_number')) || (!form_sub['housing_management_users_id'] && $check_field('add','hanguan_job_number'))"></el-input>
					<div v-else-if="$check_field('get','hanguan_job_number')">{{form_sub['hanguan_job_number']}}</div>
											</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','name_of_the_housekeeper') || $check_field('add','name_of_the_housekeeper') || $check_field('set','name_of_the_housekeeper')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="宿管姓名" prop="name_of_the_housekeeper">
												<el-input id="name_of_the_housekeeper" v-model="form_sub['name_of_the_housekeeper']" placeholder="请输入宿管姓名"
							  v-if="user_group === '管理员' || (form_sub['housing_management_users_id'] && $check_field('set','name_of_the_housekeeper')) || (!form_sub['housing_management_users_id'] && $check_field('add','name_of_the_housekeeper'))"></el-input>
					<div v-else-if="$check_field('get','name_of_the_housekeeper')">{{form_sub['name_of_the_housekeeper']}}</div>
											</el-form-item>
			</el-col>
