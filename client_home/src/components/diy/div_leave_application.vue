<template>
	<view class="diy_details diy_div_leave_application">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					...
					<view v-if="$check_field('get','leave_type')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>请假类型:</span>
						</view>
							<view class="diy_field diy_text">
					...
					<view v-if="$check_field('get','leave_days')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>请假天数:</span>
						</view>
							<view class="diy_field diy_text">
					...
					<view v-if="$check_field('get','reason_for_taking_leave')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>请假原因:</span>
						</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/leave_application/get_obj", {
					leave_application_id:this.query.leave_application_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["leave_application_id"] !==0) {
