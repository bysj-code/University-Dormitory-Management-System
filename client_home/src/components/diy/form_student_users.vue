<template>
	<div>
			<view v-if="$check_register_field('add','student_no','/student_users/view')" class="col-12 col-md-6">
			<view class="diy_title">
				...
				<view class="diy_field diy_text">
					<input type="text" id="form_student_no" v-model="form['student_no']" @blur="handleBlur($event.target.value,'student_no')"  placeholder="请输入学生学号" />
				</view>
							</view>
