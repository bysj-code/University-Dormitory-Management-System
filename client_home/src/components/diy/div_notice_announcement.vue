<template>
	<view class="diy_details diy_div_notice_announcement">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					...
					<view v-if="$check_field('get','publishing_content')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>内容:</span>
						</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/notice_announcement/get_obj", {
					notice_announcement_id:this.query.notice_announcement_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["notice_announcement_id"] !==0) {
...
<style scoped>
	.div_notice_announcement_details {}
