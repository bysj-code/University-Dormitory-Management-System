<template>
	<view class="page_housing_management_users diy_list diy_list_page div_list_tml" id="housing_management_users_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
													<uni-search-bar placeholder="搜索宿管工号" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'hanguan_job_number')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																			<uni-search-bar placeholder="搜索宿管姓名" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'name_of_the_housekeeper')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
													<!-- /搜索栏 -->
						</view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?housing_management_users_id=' + o['housing_management_users_id']" class="btn btn-primary">查看详情</navigator>
