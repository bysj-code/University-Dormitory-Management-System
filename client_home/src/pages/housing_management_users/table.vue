<template>
  <view class="page_housing_management_users diy_table diy_table_tml" id="housing_management_users_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="宿管工号" name="hanguan_job_number">
                      <uni-easyinput type="text" v-model="query.hanguan_job_number" placeholder="宿管工号" />
                    </uni-forms-item>
                    <uni-forms-item label="宿管姓名" name="name_of_the_housekeeper">
                      <uni-easyinput type="text" v-model="query.name_of_the_housekeeper" placeholder="宿管姓名" />
                    </uni-forms-item>
                </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/housing_management_users/view?" v-show="user_group == '管理员' || $check_action('/housing_management_users/table','add') || $check_action('/housing_management_users/view','add')">添加</navigator>
	...
	<view class="warp" >
		<view class="container">
			<view v-for="(o,i) in list" class="row box_style">
									<view class="col" v-if="1 && $check_field('get','hanguan_job_number')">
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									{{ o["hanguan_job_number"] }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="1 && $check_field('get','name_of_the_housekeeper')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>宿管姓名</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/housing_management_users/table','del') || $check_action('/housing_management_users/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/housing_management_users/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/housing_management_users/table','set') || $check_action('/housing_management_users/view','set') || $check_action('/housing_management_users/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
