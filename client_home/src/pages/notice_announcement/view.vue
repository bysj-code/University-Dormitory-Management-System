          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','publisher') || ($check_field('add','publisher') || $check_field('set','publisher'))" label="发布人" name="publisher">
                  ...
                  v-if="user_group === '管理员' || (form['notice_announcement_id'] && $check_field('set','publisher')) || (!form['notice_announcement_id'] && $check_field('add','publisher'))"
                ></uni-data-select>
                <uni-data-select
                  v-model="form['publisher']"
                  :localdata="list_user_publisher"
              ...
              <uni-forms-item v-if="$check_field('get','title') || ($check_field('add','title') || $check_field('set','title'))" label="标题" name="title">
                            <uni-easyinput type="text" v-model="form['title']" v-if="user_group === '管理员' || (form['notice_announcement_id'] && $check_field('set','title')) || (!form['notice_announcement_id'] && $check_field('add','title'))" :disabled="disabledObj['title_isDisabled']" />
                <!-- 仅查看 -->
              ...
              <uni-forms-item v-if="$check_field('get','release_time') || ($check_field('add','release_time') || $check_field('set','release_time'))" label="发布时间" name="release_time">
                    <uni-datetime-picker v-if="user_group === '管理员' || (form['notice_announcement_id'] && $check_field('set','release_time')) || (!form['notice_announcement_id'] && $check_field('add','release_time'))" v-model="form['release_time']" type="date" :disabled="disabledObj['release_time_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','release_time')">
                  {{ form['release_time'] }}
                </text>
                  </uni-forms-item>
              <uni-forms-item v-if="$check_field('get','publishing_content') || ($check_field('add','publishing_content') || $check_field('set','publishing_content'))" label="内容" name="publishing_content">
                    <uni-easyinput type="textarea" v-model="form['publishing_content']" v-if="user_group === '管理员' || (form['notice_announcement_id'] && $check_field('set','publishing_content')) || (!form['notice_announcement_id'] && $check_field('add','publishing_content'))" :disabled="disabledObj['publishing_content_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','publishing_content')">
                  {{ form['publishing_content'] }}
                </text>
                  </uni-forms-item>
      ...
      uni.chooseFile({
        ...
        success: function(res) {
          ...
          const uploadTask = uni.uploadFile({
            url: _self.$fullUrl('/api/notice_announcement/upload?'),
