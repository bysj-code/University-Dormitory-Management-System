<template>
	<view class="page_notice_announcement diy_detail diy_detail--new" id="notice_announcement_details">
		<view class="warp">
			<view class="container-fluid">
				<view class="row">
					...
					<view v-if="$check_field('get','publishing_content')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>内容</span>
							</view>
					...
					<view v-if="$check_field('get','related_images')" class="col-12 col-6">
						<view class="view">
							<view class="diy_title">
								<span>相关图片</span>
							</view>
								<view class="diy_field diy_img">
								<img :src="$fullUrl(obj['related_images'])" />
							</view>
							</view>
					</view>
				</view>
...
<!--						<button type="button" class="btn btn-primary" @click="cancel()">返回</button>-->
						...
						<navigator class="btn link"
							:url="'/pages/comment/edit?source_table=notice_announcement&source_field=notice_announcement_id&source_id=' + obj['notice_announcement_id']">
							评论
						</navigator>
