<template>
  <view class="page_notice_announcement diy_table diy_table_tml" id="notice_announcement_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                    ...
                    <uni-forms-item label="发布时间" name="release_time">
                      <uni-easyinput type="text" v-model="query.release_time" placeholder="发布时间" />
                    </uni-forms-item>
                    </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/notice_announcement/view?" v-show="user_group == '管理员' || $check_action('/notice_announcement/table','add') || $check_action('/notice_announcement/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','publishing_content')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>内容</span>
							</view>
															<view class="diy_field diy_text text">
								<span>
									{{ o["publishing_content"] }}
								</span>
								</view>
													</view>
					</view>
									<view class="col" v-if="1 && $check_field('get','related_images')">
						<view class="view">
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/notice_announcement/table','del') || $check_action('/notice_announcement/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/notice_announcement/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/notice_announcement/table','set') || $check_action('/notice_announcement/view','set') || $check_action('/notice_announcement/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
