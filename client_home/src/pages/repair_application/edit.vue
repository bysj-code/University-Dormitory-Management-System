<template>
	<view class="diy_edit page_repair_application" id="repair_application_edit">
		<view class='warp'>
			<view class='container'>
				<view class='row'>
						...
						<view class="diy_title diy_text_row">
							...
							<view v-if="$check_field('set','items_for_repair') || $check_field('add','items_for_repair') || $check_field('get','items_for_repair')" class="col-12 col-md-6 row-item">
						<view class="diy_title diy_text_row">
							<text>
								报修物品:
							</text>
								...
								<!-- 文本 -->
									<view class="diy_field diy_text diy_text_row">
							<input type="text" id="form_items_for_repair" v-model="form['items_for_repair']" placeholder="请输入报修物品" v-if="(form['items_for_repair'] && $check_field('set','items_for_repair')) || (!form['items_for_repair'] && $check_field('add','items_for_repair'))" :disabled="disabledObj['items_for_repair_isDisabled']" />
							<text v-else-if="$check_field('get','items_for_repair')">{{ form['items_for_repair'] }}</text>
						</view>
										</view>
							<view v-if="$check_field('set','repair_reason') || $check_field('add','repair_reason') || $check_field('get','repair_reason')" class="col-12 col-md-6 row-item">
						<view class="diy_title diy_text_row">
							<text>
								报修原因:
							</text>
						...
						<view class="diy_field diy_desc diy_text_row">
							<textarea id="form_repair_reason" v-model="form['repair_reason']" v-if="(form['repair_reason'] && $check_field('set','repair_reason')) || (!form['repair_reason'] && $check_field('add','repair_reason'))" :disabled="disabledObj['repair_reason_isDisabled']"/>
							<text v-else-if="$check_field('get','repair_reason')">{{ form['repair_reason'] }}</text>
						</view>
							</view>
