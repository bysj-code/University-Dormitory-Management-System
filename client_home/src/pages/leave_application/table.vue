<template>
  <view class="page_leave_application diy_table diy_table_tml" id="leave_application_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                        <uni-forms-item label="请假类型" name="leave_type">
                 <uni-data-select placeholder="请选择"
                        v-model="query['leave_type']"
                        :localdata="list_leave_type"
       ></uni-data-select>
                          </uni-forms-item>
                      <uni-forms-item label="请假天数" name="leave_days">
                      <uni-easyinput type="text" v-model="query.leave_days" placeholder="请假天数" />
                    </uni-forms-item>
                    </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/leave_application/view?" v-show="user_group == '管理员' || $check_action('/leave_application/table','add') || $check_action('/leave_application/view','add')">添加</navigator>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','leave_type')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>请假类型</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','leave_days')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>请假天数</span>
							</view>
						...
						<view class="view">
							<view class="diy_title" v-if="true">
								...
								<span>
									...
									<view class="col" v-if="1 && $check_field('get','reason_for_taking_leave')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>请假原因</span>
							</view>
				...
				<view class="col">
					<view class="view">
						<view class="create_time_block diy_filed diy_time">
                          ...
                          <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/leave_application/table','del') || $check_action('/leave_application/view','del')">删除</button>
                        </view>
					</view>
				</view>
				<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/leave_application/view?' + field + '=' + o[field]"
						v-show="user_group == '管理员' || $check_action('/leave_application/table','set') || $check_action('/leave_application/view','set') || $check_action('/leave_application/view','get')" class="btn btn-primary">详情</navigator>
					                    									</view>
			</view>
		</view>
	</view>
