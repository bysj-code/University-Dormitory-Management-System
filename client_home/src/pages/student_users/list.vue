<template>
	<view class="page_student_users diy_list diy_list_page div_list_tml" id="student_users_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
													<uni-search-bar placeholder="搜索学生学号" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'student_no')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																			<uni-search-bar placeholder="搜索学生姓名" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'student_name')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
													<!-- /搜索栏 -->
						</view>
		...
		<!-- 列表 -->
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
							<view class="col" v-if="1 && $check_field('get','student_no')">
						<view class="view">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?student_users_id=' + o['student_users_id']" class="btn btn-primary">查看详情</navigator>
