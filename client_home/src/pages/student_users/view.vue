          ...
          <view class="">
            <uni-forms :modelValue="form"  v-if="is_view()">
              ...
              <uni-forms-item v-if="$check_field('get','student_no') || ($check_field('add','student_no') || $check_field('set','student_no'))" label="学生学号" name="student_no">
                            <uni-easyinput type="text" v-model="form['student_no']" v-if="user_group === '管理员' || (form['student_users_id'] && $check_field('set','student_no')) || (!form['student_users_id'] && $check_field('add','student_no'))" :disabled="disabledObj['student_no_isDisabled']" />
                <!-- 仅查看 -->
                <text v-else-if="$check_field('get','student_no')">
                  {{ form['student_no'] }}
                </text>
                          </uni-forms-item>
