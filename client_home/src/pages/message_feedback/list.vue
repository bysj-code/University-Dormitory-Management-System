<template>
	<view class="page_message_feedback diy_list diy_list_page div_list_tml" id="message_feedback_list">
		<!-- 筛选模块(开始) -->
		<view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
						...
						<view class="view">
							...
							<view class="col" v-if="1 && $check_field('get','student_phone')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>学生电话</span>
							</view>
						...
						<view class="view">
							...
							<view class="col" v-if="1 && $check_field('get','message_content')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>留言内容</span>
							</view>
							...
							<view class="col" v-if="1 && $check_field('get','feedback')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>反馈意见</span>
							</view>
							...
							<view class="col" v-if="0 && $check_field('get','message_reply')">
						<view class="view">
							<view class="diy_title" v-if="true">
								<span>留言回复</span>
							</view>
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?message_feedback_id=' + o['message_feedback_id']" class="btn btn-primary">查看详情</navigator>
