<template>
	<view class="diy_edit page_check_in_application" id="check_in_application_edit">
		<view class='warp'>
			<view class='container'>
				<view class='row'>
						...
						<view class="diy_field diy_down diy_text_row diy_select_flex">
							...
							<view v-if="$check_field('set','building_name') || $check_field('add','building_name') || $check_field('get','building_name')" class="col-12 col-md-6 row-item">
						<view class="diy_title diy_text_row">
							<text>
								楼栋名称:
							</text>
								...
								<!-- 文本 -->
									<view class="diy_field diy_text diy_text_row">
							<input type="text" id="form_building_name" v-model="form['building_name']" placeholder="请输入楼栋名称" v-if="(form['building_name'] && $check_field('set','building_name')) || (!form['building_name'] && $check_field('add','building_name'))" :disabled="disabledObj['building_name_isDisabled']" />
							<text v-else-if="$check_field('get','building_name')">{{ form['building_name'] }}</text>
						</view>
										</view>
						...
						<view class="diy_title diy_text_row">
							...
							<view v-if="$check_field('set','date_of_check_in') || $check_field('add','date_of_check_in') || $check_field('get','date_of_check_in')" class="col-12 col-md-6 row-item">
						<view class="diy_title diy_text_row">
							<text>
								入住日期:
							</text>
						...
						<view class="diy_field diy_date">
							<uni-datetime-picker :disabled="disabledObj['date_of_check_in_isDisabled']" type="date" id="form_date_of_check_in" v-model="form['date_of_check_in']" placeholder="请输入入住日期" v-if="(form['date_of_check_in'] && $check_field('set','date_of_check_in')) || (!form['date_of_check_in'] && $check_field('add','date_of_check_in'))" />
							<text v-else-if="$check_field('get','date_of_check_in')">{{ form['date_of_check_in'] }}</text>
						</view>
							</view>
							<view v-if="$check_field('set','check_in_instructions') || $check_field('add','check_in_instructions') || $check_field('get','check_in_instructions')" class="col-12 col-md-6 row-item">
						<view class="diy_title diy_text_row">
							<text>
								入住说明:
							</text>
						...
						<view class="diy_field diy_desc diy_text_row">
							<textarea id="form_check_in_instructions" v-model="form['check_in_instructions']" v-if="(form['check_in_instructions'] && $check_field('set','check_in_instructions')) || (!form['check_in_instructions'] && $check_field('add','check_in_instructions'))" :disabled="disabledObj['check_in_instructions_isDisabled']"/>
							<text v-else-if="$check_field('get','check_in_instructions')">{{ form['check_in_instructions'] }}</text>
						</view>
							</view>
...
export default {
	...
	data(){
		return{
			...
			table_key:"check_in_application",
