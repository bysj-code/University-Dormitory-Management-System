<template>
	<view class="page_check_in_application diy_list diy_list_page div_list_tml" id="check_in_application_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
																	<uni-search-bar placeholder="搜索宿舍房号" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'dormitory_room_number')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																			<uni-search-bar placeholder="搜索入住日期" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'date_of_check_in')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
														<!-- /搜索栏 -->
						</view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row box_style">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator :url="'./details?check_in_application_id=' + o['check_in_application_id']" class="btn btn-primary">查看详情</navigator>
