<template>
  <view class="page_instructor diy_table diy_table_tml" id="instructor_table">
    <!-- 筛选模块(开始) -->
    <view>
          ...
          <view>
            <view class="">
              ...
              <uni-forms :modelValue="query">
                  <uni-forms-item label="辅导员工号" name="trainee_no">
                      <uni-easyinput type="text" v-model="query.trainee_no" placeholder="辅导员工号" />
                    </uni-forms-item>
                    <uni-forms-item label="辅导员姓名" name="name_of_instructor">
                      <uni-easyinput type="text" v-model="query.name_of_instructor" placeholder="辅导员姓名" />
                    </uni-forms-item>
                </uni-forms>
              <!-- /搜索栏 -->
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/instructor/view?" v-show="user_group == '管理员' || $check_action('/instructor/table','add') || $check_action('/instructor/view','add')">添加</navigator>
		...
		<view class="warp">
			<view class="container">
				<view v-for="(o,i) in list" class="row">
										<view v-if="0 && $check_field('get','trainee_no')" class="col">
						<view class="view">
                            ...
                            <span>辅导员工号</span>
								...
								<text>
									{{ o["trainee_no"] }}
													...
													<view v-if="0 && $check_field('get','name_of_instructor')" class="col">
						<view class="view">
                          <view class="diy_title" v-if="true">
                            <span>辅导员姓名</span>
                          </view>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/instructor/table','del') || $check_action('/instructor/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/instructor/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/instructor/table','set') || $check_action('/instructor/view','set') || $check_action('/instructor/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
